...
class HandRecog:
    ...
    def __init__(self, hand_label):
        ...
        ----------
            ...
            prev_gesture : int
                Represents gesture corresponding to Enum 'Gest',
                store gesture computed for previous frame.
            frame_count : int
    ...
    def set_finger_state(self):
        """
        set 'finger' by computing ratio of distance between finger tip         , middle knuckle, base knuckle.
...
class Controller:
    ...
    # to Stabilize cursor by Dampening
...
class GestureController:
    ...
    cap : Object
         obtained from cv2, for capturing video frame.
    CAM_HEIGHT : int
         highest in pixels of obtained frame from the camera.
    CAM_WIDTH : int
        width in pixels of obtained frame from the
        camera.
